...
{
    public static void FileWriterStream()
    {
        try(OutputStream out = new FileOutputStream("hyper.txt"))
        {
            out.write('A');
            out.write('B');
            out.close();
...
class FileWriterStreamEx
{
    public static void FileReaderStream()
    {
        char[] cbuf = new char[10];
        int readCount;

        try(Reader in = new FileReader("hyper.txt"))
        {
...
class File_ScanAndPrint4
{
    public static void main(String[] args) throws IOException
    {
        OutputStreamEx.FileWriterStream();
        FileWriterStreamEx.FileReaderStream();
    }
}
